import { Container, useTheme, makeStyles, Typography, Grid, Card, CardMedia, CardContent } from '@material-ui/core';
...
const Home = () => {
  ...
  const specialFeatures = [
    ...
    },
    {
      ...
      description: 'Our products are made with healthy and nutritious ingredients.',
    },
  ];
  ...
  return (
    <div>
        <Container maxWidth="lg" className={classes.root}>
            ...
            <Carousel className={classes.carousel} autoPlay={true} interval={3000} indicators={true} navButtonsAlwaysVisible={true}>
                {carouselItems.map((item, index) => (
                <div key={index}>
                    <img className={classes.carouselImage} src={item.image} alt={item.title} />
